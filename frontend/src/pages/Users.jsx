                ...
                {filtered.map((u) => (
                  <tr key={u.id} className="transition-colors hover:bg-surface">
                    ...
                    <td className="px-5 py-3 text-xs text-muted-foreground">
                      <span className="tabular-nums">{u.faceSamples}</span> face ·{" "}
                      <span className="tabular-nums">{u.voiceSamples}</span> voice
                    </td>
                    <td className="px-5 py-3 text-muted-foreground">{u.enrolledAt}</td>
                    <td className="px-5 py-3">
                      <StatusBadge
                        tone={
                          u.status === "active"
