  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        {[
          { k: "Open critical", v: alerts.filter((a) => !a.acknowledged && a.severity === "critical").length, tone: "danger" },
          { k: "Open high", v: alerts.filter((a) => !a.acknowledged && a.severity === "high").length, tone: "warning" },
          ...
          <Card key={s.k} className="border-border shadow-none">
            <CardContent className="p-5">
              ...
              <div className="mt-3 flex items-center justify-between">
                ...
                <StatusBadge tone={s.tone}>{s.tone === "danger" ? "Attention" : s.tone === "warning" ? "Watch" : "OK"}</StatusBadge>
              </div>
            </CardContent>
          </Card>
        ))}
